 	...
 	<div class="bg_img">
	 	<div class="container p-5">
			<form method="post" id="form_data">
			  	<fieldset class="">
				    <legend class="mb-4 text-center heading">
				    	<span>CONVERT YOUR CURRENCY</span>
				    </legend>

				    <div class="main_input">
				      <label for="disabledSelect" class="form-label sub_heading">CURRENCY FROM :</label>
				    ...
				    <div class="main_input">
				      <label for="disabledSelect" class="form-label sub_heading">CURRENCY TO :</label>
				    ...
				    <div class="main_input">
				      <label for="disabledTextInput" class="form-label sub_heading">AMOUNT TO BE CONVERT :</label>
				      <input type="number" name="amount" id="disabledTextInput" class="form-control" placeholder="Enter amount to be convert...">
				    </div>

				    <input type="submit" name="save" class="btn btn-primary main_input mt-2 btn_color" value="CONVERT NOW">
			  	</fieldset>
			</form>

			<div>
				<legend class="mt-4 mb-4 text-center heading"><span>OUTPUT</span></legend>
				<div id="output">
					 <span class="output_text">Nil</span>
				</div>
			</div>
	 	</div>
 	</div>
